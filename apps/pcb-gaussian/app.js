...
const WEB_VERSION = "2026-05-23-device-tune";
const EXPECTED_FIRMWARE_VERSION = "2026-05-23-device-probe";
const EXPECTED_FIRMWARE_PROTOCOL = "sx-b32-avg-settle-pair-gate-device-v1";
